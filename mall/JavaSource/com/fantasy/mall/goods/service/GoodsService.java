...
public class GoodsService implements InitializingBean {
	 ...
	 * @return
	 */
	public List<Goods> goods(Long famousId) {
		return this.goodsDao.find(Restrictions.eq("famousWine.id", famousId));
	}
	 ...
	 * @return
	 */
//	@Cacheable(key = "'getGoods' + #id", value = { "fantasy.mall.GoodsService" })
	 ...
	 * @return
	 */
	//@CacheEvict(key = "'getGoods' + #goods.id", value = "fantasy.mall.GoodsService")
