...
<@s.text name="mall.delivery.shipping.title"/>
<small>
    <@s.text name="mall.delivery.shipping.description"/>
</small>
</@override>
<@override name="head">
<script type="text/javascript">
    $(function(){
        ...
        var deleteMethod = $('.batchDelete').batchExecute($("#allChecked"),$grid.data('grid').pager(),'id','是否确认删除[{sn}]？',function(){
            $.msgbox({
                msg : " <@s.text name="mall.delivery.shipping.delete.success"/>",
                type : "success"
            });
        });
    });
...
<div id="searchFormPanel" class="button-panel pad5A">
    <@s.form id="searchForm" namespace="/system/shipping" action="search" method="post">
        <a class="btn medium">
...
<div class="batch">
    <a title=" <@s.text name="mall.delivery.shipping.button.batchdelete"/>" class="btn small primary-bg batchDelete" href="<@s.url namespace="/system/shipping" action="delete"/>">
        <span class="button-content">
            <i class="glyph-icon icon-trash float-left"></i>
            <@s.text name="mall.delivery.shipping.button.batchdelete"/>
        </span>
    </a>
</div>
<div class="grid-panel">
    <table id="view" class="table table-hover mrg5B text-center">
        ...
        <tr>
            ...
            <th class="sort" orderBy="id"><@s.text name="mall.delivery.shipping.list.sn"/></th>
            <th><@s.text name="mall.delivery.shipping.list.deliveryTypeName"/></th>
            <th><@s.text name="mall.delivery.shipping.list.deliveryCorpName"/></th>
            <th><@s.text name="mall.delivery.shipping.list.deliverySn"/></th>
            <th><@s.text name="mall.delivery.shipping.list.orderSn"/></th>
            <th class="text-center"><@s.text name="mall.delivery.shipping.list.actions"/></th>
        </tr>
        </thead>
        <tbody>
            ...
            <td class="pad0T pad0B text-center">
                <div class="dropdown actions">
                    ...
                    <ul class="dropdown-menu float-right">
                        <li>
                            <a title="<@s.text name="mall.delivery.shipping.list.actions.view"/>" class="view" href="<@s.url namespace="/system/shipping" action="view?id={id}"/>" target="after:closest('#page-content')">
                                <i class="glyph-icon icon-external-link-sign mrg5R"></i>
                                <@s.text name="mall.delivery.shipping.list.actions.view"/>
                            </a>
                        </li>
                        <li class="divider"></li>
                        <li>
                            <a href="<@s.url namespace="/system/shipping" action="delete?ids={id}"/>" class="font-red delete" title="<@s.text name="mall.delivery.shipping.list.actions.delete"/>">
                                <i class="glyph-icon icon-remove mrg5R"></i>
                                <@s.text name="mall.delivery.shipping.list.actions.delete"/>
                            </a>
                        </li>
                    </ul>
                </div>
