    ...
    <div class="example-code">
        <div class="content-box box-toggle button-toggle">
            <h3 class="content-box-header primary-bg">
                <span class="float-left"><@s.text name="mall.delivery.corp.edit.title"/></span>
            ...
            <@s.form id="saveForm" namespace="/system/deliverycorp" action="save" method="post" cssClass="center-margin">
                <@s.hidden name="id" value="%{deliveryCorp.id}"/>
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-row">
                            ...
                            <div class="form-input col-md-9">
                                <div class="append-left">
                                    <@s.textfield name="name" value="%{deliveryCorp.name}"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            <div style="float: left;padding-right: 50px;">
                                <a href="javascript:void(0);" class="btn medium primary-bg radius-all-4 menu-save4"  onclick="$('#saveForm').submit();return false;" title=" <@s.text name="mall.delivery.corp.button.save"/>"  >
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-input col-md-9">
                                <div class="append-right">
                                    <@s.textfield name="url" value="%{deliveryCorp.url}"/>
                                </div>
                            </div>
                        </div>
                    </div>
