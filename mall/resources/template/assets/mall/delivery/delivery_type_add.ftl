    ...
    <div class="example-code">
        <div class="content-box box-toggle button-toggle">
            <h3 class="content-box-header primary-bg">
                <span class="float-left"><@s.text name="mall.delivery.type.add.title"/></span>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-input col-md-9">
                                <div class="append-left">
                                  <@s.textfield name="firstWeightPrice"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="form-input col-md-9">
                                <div class="append-left">
                                    <@s.select name="defaultDeliveryCorp.id"  list="@com.fantasy.mall.delivery.service.DeliveryService@deliveryCorps()"  listKey="id" listValue="name" cssClass="chosen-select"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-input col-md-9">
                                <div class="append-right">
                                    <@s.select  name="method" list=r"#{'deliveryAgainstPayment':'先付款后发货','cashOnDelivery':'货到付款'}" cssClass="chosen-select"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="form-input col-md-9">
                                <div class="append-right">
                                    <@s.textfield name="continueWeight"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="form-input col-md-9">
                                <div class="append-right">
                                    <@s.textfield name="continueWeightPrice" />
                                </div>
                            </div>
                        </div>
                    </div>
