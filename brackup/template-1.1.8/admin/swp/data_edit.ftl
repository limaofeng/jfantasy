    ...
    <table class="formTable mb3">
        ...
        <tr>
            ...
            <td class="formItem_content">
                <@s.select name="type" value="data.type" list="@com.fantasy.swp.bean.Data$Type@values()" listValue="value"  cssClass="ui_input_text w200" />
            </td>
            <td class="formItem_title w100">作用范围</td>
            <td class="formItem_content">
            	<@s.select name="scope" value="data.scope" list="@com.fantasy.swp.bean.Data$Scope@values()" listValue="value"  cssClass="ui_input_text w200" />
            </td>
        </tr>
        <tr>
        	<td class="formItem_title">缓存时间:</td>
        	<td class="formItem_content" colspan="3" ><@s.textfield name="cacheInterval" value="data.cacheInterval" cssClass="w300" /></td>
        </tr>
        </tbody>
    </table>
    <table class="formTable mb3">
