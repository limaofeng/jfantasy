...
<script type="text/javascript">
    $(function(){
        ...
        Fantasy.area.selects($('#rootArea'),$('#EQS_parent_id','#area_list').val(),$('#parent_id'),'<select style="width:200px;"><option value="">--请选择查询的地区--</option></select>');
    });
</script>
</@override>
...
<form id="saveForm" action="${request.contextPath}/admin/system/area_save.do" method="post">
    ...
    <table class="formTable mb3 w500">
        ...
        <tr>
            ...
            <td class="formItem_content"><@s.textfield name="id" cssClass="w250" /></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="formItem_content"><@s.textfield name="sort" /></td>
        </tr>
        <tr>
