...
<form id="saveForm" action="${request.contextPath}/admin/system/website/website_save.do" method="post">
    ...
    <table class="formTable">
        ...
        <tr>
            ...
            <td class="formItem_content"><@s.textfield name="website.key" disabled="true" style="width:260px;" /></td>
            <td class="formItem_title w100">网站名称:</td>
            <td class="formItem_content"><@s.textfield name="website.name" style="width:260px;"/></td>
        </tr>
        <tr>
       	 	<td class="formItem_title">网址:</td>
            <td class="formItem_content">
            	<@s.textfield name="website.web" type="text" style="width:260px;" />
            </td>
	...
	<table id="saveFormButs" class="formTable mb3">
		<tr>
			...
			<td class="formItem_content"><a class="ui_button saveForm">保存</a></td>
		</tr>
	</table>
</form>