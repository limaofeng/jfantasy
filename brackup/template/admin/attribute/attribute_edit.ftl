...
<form id="saveForm" action="${request.contextPath}/admin/attr/goodsAttribute_save.do" method="post">
	<@s.hidden name="attribute.id"/>
	<@s.hidden name="attribute.code"/>
    <table class="formTable">
    	<caption>编辑属性<a href="###" class="back-page" style="float:right;padding-right:50px;">返回</a></caption>
        <tbody>
        <tr>
        	<td class="formItem_title w100">编码(唯一):</td>
            <td class="formItem_content">
            	<@s.textfield name="attribute.code" cssClass="w130" disabled="true"/><@s.fielderror fieldName="code"/>
            </td>
            <td class="formItem_title w100">名称:</td>
            <td class="formItem_content">
            	<@s.textfield name="attribute.name" cssClass="w130"/>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="formItem_content" colspan="3">
           		<@s.textfield name="attribute.description" style="height: 150px;width:98%;"/>
            </td>
        </tr>
        </tbody>
    </table>
