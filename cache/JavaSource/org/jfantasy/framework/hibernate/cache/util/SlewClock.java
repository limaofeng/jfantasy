...
public class SlewClock {
    ...
    private static final long DRIFT_MAXIMAL = Integer.getInteger("org.jfantasy.framework.hibernate.cache.redis.util.Timestamper.drift.max", 50);

    private static final long SLEEP_MAXIMAL = Integer.getInteger("org.jfantasy.framework.hibernate.cache.redis.util.Timestamper.sleep.max", 50);

    private static final int  SLEEP_BASE    = Integer.getInteger("org.jfantasy.framework.hibernate.cache.redis.util.Timestamper.sleep.min", 25);
