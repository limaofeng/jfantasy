package com.fantasy.framework.hibernate.cache.util;
...
public class SlewClock {
    ...
    private static final long DRIFT_MAXIMAL = Integer.getInteger("com.fantasy.framework.hibernate.cache.redis.util.Timestamper.drift.max", 50);

    private static final long SLEEP_MAXIMAL = Integer.getInteger("com.fantasy.framework.hibernate.cache.redis.util.Timestamper.sleep.max", 50);

    private static final int  SLEEP_BASE    = Integer.getInteger("com.fantasy.framework.hibernate.cache.redis.util.Timestamper.sleep.min", 25);
