package com.fantasy.framework.hibernate.cache.log;
...
public class SpringCacheMessageLogger_$logger extends DelegatingBasicLogger implements Serializable, SpringCacheMessageLogger, CoreMessageLogger, BasicLogger {
    ...
    private final static String unableToLoadConfiguration = "HHH020004: A configurationResourceName was set to %s but the resource could not be loaded from the classpath. Ehcache will configure itself using defaults.";
    ...
    private final static String attemptToRestartAlreadyStartedEhCacheProvider = "HHH020001: Attempt to restart an already started EhCacheRegionFactory.  Use sessionFactory.close() between repeated calls to buildSessionFactory. Using previously created EhCacheRegionFactory. If this behaviour is required, consider using org.hibernate.cache.ehcache.SingletonEhCacheRegionFactory.";
    ...
    private final static String unableToFindEhCacheConfiguration = "HHH020003: Could not find a specific ehcache configuration for cache named [%s]; using defaults.";
