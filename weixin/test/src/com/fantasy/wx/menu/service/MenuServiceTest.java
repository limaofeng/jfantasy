...
public class MenuServiceTest {
    ...
    public void setUp() throws Exception {
        ...
        menuService.saveList(menuList);
    }

    @After
    public void tearDown() throws Exception {
        List<Menu> menus=menuService.findAll(new ArrayList<PropertyFilter>());
    ...
    public void testFindPager() throws Exception {
        ...
        Pager p=menuService.findPager(pager,list);
    ...
    public void testGet() throws Exception {
        List<Menu> menus=menuService.findAll(new ArrayList<PropertyFilter>());
        Menu m=menuService.get(menus.get(0).getId());
        Assert.assertNotNull(m);
        logger.debug(m);
    }
    @Test
    public void testRefresh() throws Exception {
        int r=menuService.refresh();
        Assert.assertEquals(r,0);
    }

    @Test
    public void testDeleteMenu() throws Exception {
        int r=menuService.deleteMenu();
        Assert.assertEquals(r,0);
    }
}