    ...
    <div class="example-code">
        <div class="content-box box-toggle button-toggle">
            <h3 class="content-box-header primary-bg">
                <span class="float-left"><@s.text name="common.area.add.title"/></span>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-input col-md-9">
                                <div class="append-left">
                                    <@s.select id="rootArea" headerKey="" headerValue="--添加到当前地区--" list="@com.fantasy.common.service.AreaService@list(#parameters['parentId'])" listKey="id" listValue="name" cssStyle="width:200px;" value="''"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="form-input col-md-9">
                                <div class="append-left">
                                    <@s.textfield name="id" cssClass="w250" />
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
