...
public class RegexpCst {
	 ...
	 * 手机
	 */
	public static Pattern VALIDATOR_MOBILE = getPattern("^(13|15|18|14)[0-9]{9}$");
	/**
	 * ip4 地址
	 */
	...
	public static void main(String[] strs) {
		String p = "^([\\S\\s]+)?\\<([\\S\\s]+)\\>";
		System.out.println(RegexpUtil.isMatch("李茂峰<limaofeng@msn.com>", p));
		System.out.println(RegexpUtil.parseGroup("李茂峰<limaofeng@msn.com>", p, 1));
		System.out.println(RegexpUtil.parseGroup("李茂峰<limaofeng@msn.com>", p, 2));
	}
