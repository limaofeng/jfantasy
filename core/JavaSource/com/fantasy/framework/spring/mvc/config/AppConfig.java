 ...
 */
@Configuration
@ComponentScan(basePackages = "com.fantasy.modules", excludeFilters = {@ComponentScan.Filter(type = FilterType.ANNOTATION, value = {Controller.class})})
...
//	}
    ...
    public BuguIndex buguIndex() {
        ...
        buguIndex.setBasePackage("com.fantasy.cms");
