...
import com.fantasy.framework.dao.hibernate.AnnotationSessionFactoryBean;
import com.fantasy.framework.dao.mybatis.SqlSessionFactoryBean;
...
public class DaoConfig {
    ...
    public SqlSessionFactoryBean sqlSessionFactoryBean() {
        ...
        sqlSessionFactoryBean.setMybatisProperties(new HashMap<String, Object>() {
            {
                this.put("mybatis.dialect", "com.fantasy.framework.dao.mybatis.dialect.MySQLDialect");
            }
        });
...
//        sessionFactory.setPackagesToScan(packagesToScan);
        ...
        hibernateProperties.setProperty("hibernate.cache.region.factory_class", "com.fantasy.framework.hibernate.cache.SpringCacheRegionFactory");
        */
