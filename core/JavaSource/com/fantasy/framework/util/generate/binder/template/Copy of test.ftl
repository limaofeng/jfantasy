...
public class ${util.toSimpleJavaType(serviceClass)}Test {
	 ...
	 * @param pagination
	 * @param ${util.lowerCaseFirst(table.simpleName)}
	 * @return aia.cn.isp.core.dao.Pagination<${beanClass}>
	 */
	@Test
	public void list${util.toSimpleJavaType(table.simpleName)}(){
		Pagination<${util.toSimpleJavaType(table.simpleName)}> pagination = new Pagination<${util.toSimpleJavaType(table.simpleName)}>(10);
		${util.toSimpleJavaType(table.simpleName)} ${util.lowerCaseFirst(table.simpleName)} = new ${util.toSimpleJavaType(table.simpleName)}();
		LOG.debug(JSON.serialize(${util.lowerCaseFirst(util.toSimpleJavaType(serviceClass))}.list${util.toSimpleJavaType(table.simpleName)}(pagination,${util.lowerCaseFirst(table.simpleName)})));
	}
