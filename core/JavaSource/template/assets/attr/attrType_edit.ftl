    ...
    <div class="example-code">
        <div class="content-box box-toggle button-toggle">
            <h3 class="content-box-header primary-bg">
                <span class="float-left">属性类型编辑</span>
        ...
        <@s.form id="saveForm" namespace="/attr" action="type_save" method="post" cssClass="center-margin">
            <@s.hidden name="id" value="%{attributeType.id}"/>
            <div class="row">
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-row">
                            ...
                            <div class="form-input col-md-9">
                                <div class="append-left">
                                    <@s.textfield name="name" id="name" value="%{attributeType.name}"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="form-input col-md-9">
                                <div class="append-left">
                                    <@s.select name="converter.id" value="%{attributeType.converter.id}" list="@com.fantasy.attr.service.ConverterService@findAll()"  listKey="id" listValue="name" cssClass="chosen-select" data_placeholder="请选择类型对应的转换器"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="form-input col-md-9">
                                <div class="append-left">
                                    <@s.textarea name="description" cssStyle="height: 150px;width:888px;" value="%{attributeType.description}"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-input col-md-9">
                                <div class="append-right">
                                    <@s.textfield id="dataType" name="dataType" value="%{attributeType.dataType}"/>
                                </div>
                            </div>
                        </div>
                    </div>
