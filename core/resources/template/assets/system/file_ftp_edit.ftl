                        ...
                        <div class="form-row">
                            ...
                            <div class="form-input col-md-9">
                                <div class="append-left">
                                    <@s.textfield name="name" value="%{ftp.name}"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="form-input col-md-9">
                                <div class="append-left">
                                    <@s.textfield name="hostname" value="%{ftp.hostname}"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="form-input col-md-9">
                                <div class="append-left">
                                    <@s.textfield name="username" value="%{ftp.username}"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="form-input col-md-9">
                                <div class="append-left">
                                    <@s.textfield name="defaultDir" value="%{ftp.defaultDir}" cssStyle="width:880px;"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="form-input col-md-9">
                                <div class="append-left">
                                    <@s.textarea name="description" cssStyle="width: 880px; height: 118px;" value="%{ftp.description}"/>
                                </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-input col-md-9">
                                <div class="append-right">
                                    <@s.select name="controlEncoding" list=r"#{'UTF-8','GBK'}" listValue="key" cssClass="chosen-select" value="%{ftp.controlEncoding}"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="form-input col-md-9">
                                <div class="append-right">
                                    <@s.textfield name="port" value="%{ftp.port}"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="form-input col-md-9">
                                <div class="append-right">
                                    <input type="password" name="password" value="${ftp.password}"/>
                                </div>
                            </div>
                        </div>
                    </div>
