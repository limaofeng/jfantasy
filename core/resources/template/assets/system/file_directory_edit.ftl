    ...
    <div class="example-code">
        <div class="content-box box-toggle button-toggle">
            <h3 class="content-box-header primary-bg">
                <span class="float-left"><@s.text name="file.directory.edit.title"/></span>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-input col-md-9">
                                <div class="append-left">
                                    <@s.textfield name="key" value="%{directory.key}" disabled="true"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="form-input col-md-9">
                                <div class="append-left">
                                    <@s.select name="fileManager.id" list="@com.fantasy.file.service.FileManagerFactory@getFileManagers()" listKey="id" headerKey="" headerValue="--请选择--" listValue="name" cssClass="chosen-select" value="%{directory.fileManager.id}"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-input col-md-9">
                                <div class="append-right">
                                    <@s.textfield name="name" value="%{directory.name}"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="form-input col-md-9">
                                <div class="append-right">
                                    <@s.textfield name="dirPath" value="%{directory.dirPath}"/>
                                </div>
                            </div>
                        </div>
                    </div>
