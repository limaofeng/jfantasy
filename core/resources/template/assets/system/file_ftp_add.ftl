    ...
    <div class="example-code">
        <div class="content-box box-toggle button-toggle">
            <h3 class="content-box-header primary-bg">
                <span class="float-left">FTP站点添加</span>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-input col-md-9">
                                <div class="append-left">
                                    <@s.textfield name="defaultDir" value="/" cssStyle="width:880px;"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-input col-md-9">
                                <div class="append-right">
                                    <@s.select name="controlEncoding" list=r"#{'UTF-8','GBK'}" listValue="key" cssClass="chosen-select"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="form-input col-md-9">
                                <div class="append-right">
                                    <@s.textfield name="port" value="21"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
