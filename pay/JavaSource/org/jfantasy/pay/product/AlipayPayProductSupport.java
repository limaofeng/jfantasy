...
import org.jfantasy.pay.product.httpClient.HttpProtocolHandler;
import org.jfantasy.pay.product.httpClient.HttpRequest;
import org.jfantasy.pay.product.httpClient.HttpResponse;
import org.jfantasy.pay.product.httpClient.HttpResultType;
...
public abstract class AlipayPayProductSupport extends PayProductSupport {
     ...
     * @return 签名结果字符串
     */
    public static String buildRequestMysign(Map<String, String> sPara, PayConfig config) {
     ...
     * @return 要请求的参数数组
     */
    protected static Map<String, String> buildRequestPara(Map<String, String> sParaTemp, PayConfig config) {
     ...
     * @return 支付宝处理结果
     */
    public static String buildRequest(String aLIPAYGATEWAYNEW, String strParaFileName, String strFilePath, Map<String, String> sParaTemp, PayConfig payConfig) throws IOException {
        //待请求参数数组
