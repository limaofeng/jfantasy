...
import com.fantasy.framework.struts2.rest.handler.ContentTypeHandler;
import com.fantasy.framework.struts2.rest.handler.HtmlHandler;
 ...
 */
public class RestActionInvocation extends FantasyActionInvocation {
    ...
    public RestActionInvocation(final Map<String, Object> extraContext, boolean pushAction) {
    ...
    private void executeResult() throws Exception {
        ...
        ContentTypeHandler handler = handlerSelector.getHandlerForResponse(ServletActionContext.getRequest(), ServletActionContext.getResponse());
