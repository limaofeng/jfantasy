package com.fantasy.framework.struts2.core;

import com.fantasy.framework.struts2.core.context.ActionConstants;
import com.fantasy.framework.struts2.core.interceptor.ParametersInterceptor.MethodParam;
...
public class FantasyActionInvocation implements ActionInvocation {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(FantasyActionInvocation.class);
    ...
    public FantasyActionInvocation(final Map<String, Object> extraContext, final boolean pushAction) {
        FantasyActionInvocation.this.extraContext = extraContext;
        FantasyActionInvocation.this.pushAction = pushAction;
    }
    ...
    public String invoke() throws Exception {
        ...
        try {
            ...
            if (interceptors.hasNext()) {
                ...
                try {
                    resultCode = interceptor.getInterceptor().intercept(FantasyActionInvocation.this);
                } finally {
