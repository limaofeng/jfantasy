        ...
        <div id="normal-tabs-1">
                <div class="row issue-date">
                    <div class="col-md-6">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-input col-md-8 col-md-offset-1">
                                <div class="append-left">
                                    <@s.select cssClass="chosen-select" list="@com.fantasy.attr.service.AttributeTypeService@allAttributeType()" value="%{attribute.attributeType.id}" name="attributeType.id" listKey="id" listValue="name" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-checkbox-radio col-md-9">
                                <div class="append-right">
                                    <@s.radio list=r"#{true:'是',false:'否'}" name="nonNull" value="%{attribute.nonNull}" />
                                </div>
                            </div>
                        </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-input col-md-10">
                        <@s.textarea name="description" id="description" value="%{attribute.description}"/>
                    </div>
                </div>
        </div>
    </div>
